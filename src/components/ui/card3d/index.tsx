...
import { CSSProperties, forwardRef, MouseEventHandler, ReactNode, useCallback, useRef, useState } from 'react';
...
const Card3d = forwardRef<HTMLDivElement, Card3dProps>(
  ({ children, showMask = true, className, maskClass, scaleNum = 1.05, style, onClick }, ref) => {
